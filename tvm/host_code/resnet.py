...
model_path='//upb/scratch/departments/pc2/groups/pc2-cc-user/custonn2/designs/tvm_models/resnet50/resnet_frozen.pb'
...
with nnvm.compiler.build_config(opt_level=3):
    # graph_new = nnvm.compiler.optimize(sym, shape=None, dtype='float32')
    graph, lib, params = nnvm.compiler.build(sym,  target=target, target_host=target_host , params=params)

print(type(graph))
with open('resnet_ir.txt', 'w') as file:
    file.write(graph.ir())
###for relay ir
'''
