...
//#ifndef EXERCISE1
    ...
    std::ifstream aocx_stream("/upb/scratch/departments/pc2/groups/pc2-cc-user/custonn2/nikhitha/pg-custonn2-2018/tutorial/Task1/SimpleKernel.aocx", std::ios::in|std::ios::binary);
