...
\subsection{Disadvantages}
 ...
 \subsection{Selection of Technologies}
Reasons for selecting OpenVino and TVM
 ...
 \item OpenCL kernels generated by TVM for the CNN model needs to be compiled separately to create bitstreams. The FPGA compilation takes a long time to create bitstreams which is not the case for OpenVino. Due to this, we plan to use TVM only for the generation of OpenCL kernels.
