...
{
    printf("Kernel started feeder_4e \n");
...
{
    printf("Kernel started Mixed_4e_Branch_0_Conv2d_0a_1x1_Conv2D \n");
...
#pragma unroll 64
    ...
    printf("Kernel fnshd Mixed_4e_Branch_0_Conv2d_0a_1x1_Conv2D \n");
}

__kernel void Mixed_4e_Branch_1_Conv2d_0a_1x1_Conv2D(__global float *restrict input1,
                                                     __global float *restrict input2)
{
    printf("Kernel started Mixed_4e_Branch_1_Conv2d_0a_1x1_Conv2D \n");
    //Read Input from IO channel
    float input0[100352];
    // 100352/8 = 12544
    for (int i = 0; i < 12544; i++)
...
#pragma unroll 64
    ...
    printf("Kernel fnshd Mixed_4e_Branch_1_Conv2d_0a_1x1_Conv2D \n");
}
__kernel void Padding_Mixed_4e_Branch_1_Conv2d_0b_3x3_Conv2D()
{
    printf("Kernel started Padding_Mixed_4e_Branch_1_Conv2d_0b_3x3_Conv2D \n");
    ...
    printf("Kernel fnshd Padding_Mixed_4e_Branch_1_Conv2d_0b_3x3_Conv2D \n");
}
...
__kernel void Mixed_4e_Branch_1_Conv2d_0b_3x3_Conv2D(__global float *restrict input1,
                                                     ...
                                                     __global float *restrict output)
{
    printf("Kernel started Mixed_4e_Branch_1_Conv2d_0b_3x3_Conv2D \n");
    float input0[36864];
...
#pragma unroll
    ...
    printf("Kernel fnshd Mixed_4e_Branch_1_Conv2d_0b_3x3_Conv2D \n");
}

__kernel void Mixed_4e_Branch_2_Conv2d_0a_1x1_Conv2D(__global float *restrict input1,
                                                     __global float *restrict input2)
{
    printf("Kernel started Mixed_4e_Branch_2_Conv2d_0a_1x1_Conv2D \n");
    //Read Input from IO channel
    float input0[100352];
    // 100352/8 = 12544
    for (int i = 0; i < 12544; i++)
...
#pragma unroll 128
    ...
    printf("Kernel fnshd Mixed_4e_Branch_2_Conv2d_0a_1x1_Conv2D \n");
}
__kernel void Padding_Mixed_4e_Branch_2_Conv2d_0b_3x3_Conv2D()
{
    printf("Kernel started Padding_Mixed_4e_Branch_2_Conv2d_0b_3x3_Conv2D \n");
    ...
    printf("Kernel fnshd Padding_Mixed_4e_Branch_2_Conv2d_0b_3x3_Conv2D \n");
}
__kernel void Mixed_4e_Branch_2_Conv2d_0b_3x3_Conv2D(__global float *restrict input1,
                                                     __global float *restrict input2,
                                                     __global float *restrict output)
{
    printf("Kernel started Mixed_4e_Branch_2_Conv2d_0b_3x3_Conv2D \n");
    float input0[8192];
...
{
    printf("Kernel started Mixed_4e_Branch_3_MaxPool_0a_3x3_MaxPool \n");
    //Read Input from IO channel
...
#pragma unroll
    ...
    printf("Kernel fnshd Mixed_4e_Branch_3_MaxPool_0a_3x3_MaxPool \n");
}

__kernel void Mixed_4e_Branch_3_Conv2d_0b_1x1_Conv2D(__global float *restrict input1,
                                                     __global float *restrict input2,
                                                     __global float *restrict output)
{
    printf("Kernel started Mixed_4e_Branch_3_Conv2d_0b_1x1_Conv2D \n");
...
__kernel void Mixed_4e_concat(unsigned int route_to, __global float *restrict input0, __global float *restrict input1, __global float *restrict input2, __global float *restrict input3)
{
    ...
    */
    ...
    printf("Kernel fnshd Mixed_4e_concat \n");
}
