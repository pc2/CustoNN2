...
#pragma unroll
        ...
        for (int yy = 0; yy < 14; ++yy)
        {
            for (int xx = 0; xx < 14; ++xx)
            {
                ...
                write_channel_intel(conv1_4b_out_b0_channel, temp_out[yy][xx]);
            }
        }
    }
}
...
#pragma unroll
        ...
        for (int yy = 0; yy < 14; ++yy)
        {
            for (int xx = 0; xx < 14; ++xx)
            {
                temp_out[yy][xx] += input_bias[ff];
                temp_out[yy][xx] = (temp_out[yy][xx] > 0) ? temp_out[yy][xx] : 0.000000e+00f;
                write_channel_intel(conv2_1_4b_out_b1_channel, temp_out[yy][xx]);
            }
        }
    }
}
...
#pragma unroll
        ...
        for (int yy = 0; yy < 14; ++yy)
        {
            for (int xx = 0; xx < 14; ++xx)
            {
                ...
                write_channel_intel(conv2_2_4b_out_b1_channel, temp_out[yy][xx]);
            }
        }
    }
}
...
#pragma unroll
        ...
        for (int yy = 0; yy < 14; ++yy)
        {
            for (int xx = 0; xx < 14; ++xx)
            {
                temp_out[yy][xx] += input_bias[ff];
                temp_out[yy][xx] = (temp_out[yy][xx] > 0) ? temp_out[yy][xx] : 0.000000e+00f;
                write_channel_intel(conv3_1_4b_out_b2_channel, temp_out[yy][xx]);
            }
        }
    }
}
...
#pragma unroll
        ...
        for (int yy = 0; yy < 14; ++yy)
        {
            for (int xx = 0; xx < 14; ++xx)
            {
                temp_out[yy][xx] += input_bias[ff];
                temp_out[yy][xx] = (temp_out[yy][xx] > 0) ? temp_out[yy][xx] : 0.0;
                write_channel_intel(conv3_2_4b_out_b2_channel, temp_out[yy][xx]);
            }
        }
    }
...
#pragma unroll 
        ...
        for (int yy = 0; yy < 14; ++yy)
        {
            for (int xx = 0; xx < 14; ++xx)
            {
                temp_out[yy][xx] += input_bias[ff];
                temp_out[yy][xx] = (temp_out[yy][xx] > 0) ? temp_out[yy][xx] : 0.000000e+00f;
                write_channel_intel(conv4_1_4b_out_b3_channel, temp_out[yy][xx]);
            }
        }
    }
}
