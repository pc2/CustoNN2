...
channel concat_3a_struct concat_3a_in_channel __attribute__((depth(10))) __attribute__((io("kernel_input_ch0"))); // Channel Tx
channel concat_3b_struct concat_3b_out_channel __attribute__((depth(10))) __attribute__((io("kernel_output_ch0"))); // Channel Rx
