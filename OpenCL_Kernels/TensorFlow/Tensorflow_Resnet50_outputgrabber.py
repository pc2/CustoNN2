...
with tf.Graph().as_default() as graph: # Set default graph as graph
           ...
           with tf.Session() as sess:
                ...
                with tf.gfile.FastGFile("resnet_frozen.pb",'rb') as f:
                                ...
                                run_until = 'resnet_v2_50/block1/unit_1/bottleneck_v2/preact/Relu:0'
                                ...
                                try:
                                    inception_model,block_lvl,unit_lvl,bottleneck_lvl,operation_name,extra_info = run_until.split("/")
                                    extra_info = extra_info.split(':')
                                    file_path_info = str(block_lvl)+"_"+str(unit_lvl)+"_"+str(bottleneck_lvl)+"_"+str(operation_name)+"_"+str(extra_info[0])
                                except:
                                    inception_model,operation_name,extra_info = run_until.split("/")
                                    extra_info = extra_info.split(':')
                                    file_path_info = str(operation_name)+"_"+str(extra_info[0])
                                ...
                                file_path_xxxx ="D:\Paderborn\ProjectCNNFPGA\Tensorflow_code\\resnet\\outs"
