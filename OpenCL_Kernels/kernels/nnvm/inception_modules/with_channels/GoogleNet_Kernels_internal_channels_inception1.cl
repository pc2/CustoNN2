...
__kernel void Mixed_3c_Branch_0_Conv2d_0a_1x1_Conv2D(__global float *restrict input0, __global float *restrict input1, __global float *restrict input2)
{
...
__kernel void Mixed_3c_Branch_1_Conv2d_0a_1x1_Conv2D(__global float *restrict input0, __global float *restrict input1, __global float *restrict input2)
...
__kernel void Mixed_3c_Branch_2_Conv2d_0a_1x1_Conv2D(__global float *restrict input0,
...
__kernel void Mixed_3c_concat(__global float *restrict T_transpose)
            {
                float input0[128*28*28];
                for (int i = 0; i < 128*28*28; i++ ){
